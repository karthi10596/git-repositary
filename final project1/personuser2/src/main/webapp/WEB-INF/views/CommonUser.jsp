...
<c:when test="${sessionScope.UserLoggedIn != null}">
    ...
    <ol class="carousel-indicators">
      ...
      <div class="item active">
        ...
        <img src="resources/watch1.jpg " alt="New York" width="100%" height="700"> 
      </div>
      <div class="item">
        <img src="resources/watch2.jpg "  alt="Chicago" width="100%" height="700">     
      </div>
    
      <div class="item">
        <img src="resources/watch3.jpg "  alt="Los Angeles" width="100%" height="700">      
      </div>
    </div>
