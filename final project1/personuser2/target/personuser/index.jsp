...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
	...
	<li><a href="fetchpage">FETCHDATA</a></li>
...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p><span class="glyphicon glyphicon-envelope"></span>Email:karthi10596@gmail.com</p>
    </div>
    <div class="col-md-8">
      <div class="row">
  ...
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#menu1">karthi</a></li>
    <li><a data-toggle="tab" href="#menu2">ram</a></li>
  </ul>
